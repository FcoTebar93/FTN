...
export const uiText = {
  es: {
    ...
    credentials: {
      ...
      subtitle: "Configura Stripe, notificaciones, Google Sheets, Twilio, KYC y más.",
      ...
      googleConnecting: "Redirigiendo a Google...",
      googleDisconnecting: "Desconectando...",
      googleConnectHint: "Autoriza el acceso a tus hojas de Google. FTN guardará el token de forma cifrada en tu credencial.",
      googleConnected: "Google Sheets conectado correctamente.",
      googleDisconnected: "Google Sheets desconectado.",
      googleConnectErrorPrefix: "Error al conectar Google:",
      googleConnectedAs: (email: string) => `Conectado como ${email}`,
      googleConnectedUnknown: "cuenta de Google",
    },
    providerSchemas: {
    ...
    designer: {
      ...
      googleSheets: {
        crudQuickAdd: "Atajos Google Sheets (añade un paso CRUD preconfigurado):",
        findRows: "Buscar filas",
        appendRows: "Añadir filas",
        createRow: "Crear fila",
        updateRow: "Actualizar fila",
        deleteRow: "Borrar fila",
        findRowsStep: "Buscar filas en hoja",
        appendRowsStep: "Añadir filas al final",
        createRowStep: "Crear fila en hoja",
        updateRowStep: "Actualizar fila en hoja",
        deleteRowStep: "Borrar fila de hoja",
        spreadsheetId: "ID del spreadsheet",
        spreadsheetIdHint: "Copia el ID de la URL de Google Sheets (entre /d/ y /edit).",
        sheetName: "Nombre de la pestaña",
        rowIndex: "Fila (1 = primera fila de datos)",
        rowsJson: "Filas (JSON)",
        rowsJsonHint: 'Array de filas, p. ej. [["2026-06-15","pedido",42]]',
        valuesJson: "Valores (JSON)",
        valuesJsonHint: 'Objeto por cabecera o array, p. ej. {"status":"pending","amount":10}',
        filtersJson: "Filtros (JSON)",
        filtersJsonHint: 'Array AND, p. ej. [{"column":"status","operator":"eq","value":"pending"}]',
        limit: "Límite de resultados",
        hasHeaderRow: "La primera fila son cabeceras",
        valueInputOption: "Modo de escritura",
        jsonInvalid: "JSON inválido en este campo.",
        chooseAction: "Elige una acción de Google Sheets arriba.",
      },
    },
  },
  en: {
    ...
    credentials: {
      ...
      subtitle: "Configure Stripe, notifications, Google Sheets, Twilio, KYC and more.",
      ...
      googleConnecting: "Redirecting to Google...",
      googleDisconnecting: "Disconnecting...",
      googleConnectHint: "Authorize access to your Google spreadsheets. FTN stores the token encrypted in your credential.",
      googleConnected: "Google Sheets connected successfully.",
      googleDisconnected: "Google Sheets disconnected.",
      googleConnectErrorPrefix: "Error connecting Google:",
      googleConnectedAs: (email: string) => `Connected as ${email}`,
      googleConnectedUnknown: "Google account",
    },
    providerSchemas: {
    ...
    designer: {
      ...
      googleSheets: {
        crudQuickAdd: "Google Sheets shortcuts (add a preconfigured CRUD step):",
        findRows: "Find rows",
        appendRows: "Append rows",
        createRow: "Create row",
        updateRow: "Update row",
        deleteRow: "Delete row",
        findRowsStep: "Find rows in sheet",
        appendRowsStep: "Append rows to sheet",
        createRowStep: "Create row in sheet",
        updateRowStep: "Update row in sheet",
        deleteRowStep: "Delete row from sheet",
        spreadsheetId: "Spreadsheet ID",
        spreadsheetIdHint: "Copy the ID from the Google Sheets URL (between /d/ and /edit).",
        sheetName: "Sheet name",
        rowIndex: "Row index (1 = first data row)",
        rowsJson: "Rows (JSON)",
        rowsJsonHint: 'Array of rows, e.g. [["2026-06-15","order",42]]',
        valuesJson: "Values (JSON)",
        valuesJsonHint: 'Header map or array, e.g. {"status":"pending","amount":10}',
        filtersJson: "Filters (JSON)",
        filtersJsonHint: 'AND filters, e.g. [{"column":"status","operator":"eq","value":"pending"}]',
        limit: "Result limit",
        hasHeaderRow: "First row contains headers",
        valueInputOption: "Value input mode",
        jsonInvalid: "Invalid JSON in this field.",
        chooseAction: "Choose a Google Sheets action above.",
      },
    },
  },
} as const;
